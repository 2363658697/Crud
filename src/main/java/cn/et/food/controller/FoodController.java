...
public class FoodController {
	...
	public PageTools queryFoodList(String foodName,Integer page,Integer rows,String sort)
			throws Exception {
		PageTools queryFoodList = foodService.queryFoodByFoodName(foodName, page, rows, sort);
	...
	public Result saveFood(Food food) throws Exception {
